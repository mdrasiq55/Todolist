...
// Railway automatic-ah PORT assign pannum, illana 5050 use pannum
const PORT = process.env.PORT || 5050;

app.use(express.json());
// Path handling for Backend to Public folder
app.use(express.static(path.join(__dirname, '..', 'public')));

// ✅ Database Connection (Railway Variables)
const pool = new Pool({
  connectionString: process.env.DATABASE_URL, // Railway tharura URL inga varum
  ssl: {
    rejectUnauthorized: false // Cloud deployment-ku idhu romba mukkiyam
  }
});
